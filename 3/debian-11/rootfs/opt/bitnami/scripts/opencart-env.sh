...
export OPENCART_ADMIN_CONF_FILE="${OPENCART_BASE_DIR}/admin/config.php"
...
export OPENCART_DATA_TO_PERSIST="${OPENCART_DATA_TO_PERSIST:-config.php admin/config.php}"
...
export OPENCART_ENABLE_HTTPS_ONLY="${OPENCART_ENABLE_HTTPS_ONLY:-no}" # only used during the first initialization
